...
export default class Overlay {
  ...
  previewMedia(url, mediaType, fitMode) {
    ...
    if (mediaType === "image") {
      ...
      video.autoplay =
        this.dom.dataset.previewAutoplay === "false" ? false : true;
      video.controls =
        this.dom.dataset.previewControls === "false" ? false : true;
  ...
  onSlidesClicked(event) {
    ...
    if (linkTarget) {
      ...
      let url =
        ...
        linkTarget.getAttribute("data-preview-link");
      if (url) {
    ...
    // Was a media lightbox trigger clicked?
      ...
      if (mediaTarget.hasAttribute("data-preview-image")) {
        let url =
          mediaTarget.dataset.previewImage || mediaTarget.getAttribute("src");
        if (url) {
        ...
        let url =
          mediaTarget.dataset.previewVideo || mediaTarget.getAttribute("src");
        if (!url) {
