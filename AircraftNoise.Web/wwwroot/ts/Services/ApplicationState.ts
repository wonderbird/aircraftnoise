...
export class ApplicationState {
  ...
  private static readonly _noiseEventRepository: NoiseEventRepository =
    new NoiseEventRepository();
  ...
  static get instance(): ApplicationState {
    if (!ApplicationState._instance) {
      throw new Error(
        "You must call ApplicationState.initialize() before creating any objects using ApplicationState. It is best to call ApplicationState.initialize() at the beginning of the main entry point of your application.",
      );
    }
