...
export class MeasurementStationView {
  ...
  constructor() {
    ...
    this.positionErrorLabel = document.querySelector(
      "#position-error",
    ) as HTMLDivElement;
    this.positionErrorMessageLabel = document.querySelector(
      "#position-error-message",
    ) as HTMLSpanElement;
    this.nextMeasurementStationInfo = document.querySelector(
      "#next-measurement-station-info",
    ) as HTMLDivElement;
    ...
    if (
      ...
      locateButton.addEventListener(
        "click",
        this.presenter.getCurrentPosition.bind(this.presenter),
      );
    }
  }
