...
public class InMemoryMeasurementProviderTests
{
    ...
    public async Task GetNoiseMeasurementsForPastTimePeriodAsync_RequestedEndTimeMatchesFirstMeasurement_ReturnsFirstMeasurement()
    {
        ...
        var peakTimestampUtc = DateTime.Parse(configuredPeakTimestamp, CultureInfo.InvariantCulture, DateTimeStyles.AdjustToUniversal);
        ...
        var firstMeasurementTimestamp = firstMeasurement.Timestamp.ToString("yyyy-MM-ddTHH:mm:ssZ", System.Globalization.CultureInfo.InvariantCulture);
